package com.enterprise.merchant.config;

import com.enterprise.merchant.security.HeaderRequestAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/merchants/validate").permitAll() // Internal calls allowed
